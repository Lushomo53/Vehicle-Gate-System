...
public class EmailService {
    ...
    public static final String SYSTEM_USERNAME = "lungolushomo21@gmail.com";
    public static final String PASSWORD = "vkbzxpvyleqjjywk";
    public static final int TLS_PORT_NUMBER = 587;
